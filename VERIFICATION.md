...
- 2026-09-15: production build proven end to end (first ever `npm run build` + prod smoke 6/6); Dockerfile/.dockerignore added; DEPLOY.md rewritten as the GitHub → Contabo/Coolify runbook; git history scanned clean (.env never committed, only `sk-…` placeholders).
